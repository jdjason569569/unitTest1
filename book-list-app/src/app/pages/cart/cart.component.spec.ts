...
describe('Cart component', ()=>{
    ...
    beforeEach(()=>{                         //Se ejecuta antes de lanzar los test
      TestBed.configureTestingModule({  //Se configura el test
         imports: [
            HttpClientTestingModule          //Permite realizar peticiones fake, se colocan todos los modulos necesarios, por ejemplo angular material un calendar , o para formularios reactivos
         ],
    ...
    beforeEach(()=>{
        ...
        fixture.detectChanges();  //permite detectar los cambios en el ngOinit
    ...
    //   }
      ...
      it('_clearListCartBook works correctly', ()=>{ //En este caso se prueba un metodo privado directamente
        ...
        component.listCartBook = listBook;
        component['_clearListCartBook']();  //Se llama el metodo privado
